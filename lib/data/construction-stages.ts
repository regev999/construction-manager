...
export const DEFAULT_STAGES: DefaultStage[] = [
  ...
  },
  {
    ...
    tasks: [
      {
        name: 'הוצאת תיק מידע מהוועדה המקומית',
        description: 'הגשת בקשה לתיק מידע (היתר עקרוני) מהוועדה המקומית לתכנון. מסמך זה מפרט את זכויות הבנייה, קווי הבניין, אחוזים ותנאים מיוחדים למגרש הספציפי שלך',
        priority: 'critical',
        planned_cost: 300,
        why_important: 'תיק המידע הוא "רישיון לתכנן" — האדריכל לא יכול לתכנן נכון בלעדיו. הוא מראה בדיוק מה מותר לבנות על המגרש שלך',
        what_if_skip: 'תכנון אדריכלי שלא מתאים לדרישות הוועדה = שינויים יקרים, עיכובים של חודשים וכסף מבוזבז',
        pro_tip: 'ניתן להגיש בקשה לתיק מידע דרך מערכת "רישוי זמין" (risuyzamin.gov.il). ממוצע המתנה: 30-60 יום. הזמן מיד אחרי רכישת הקרקע',
        is_required: true,
      },
      {
        name: 'בחירת אדריכל',
      ...
      {
        name: 'פיקוד העורף — תכניות מרחב מוגן',
        description: 'הגשת תוכניות מרחב מוגן דירתי (ממ"ד) לאישור פיקוד העורף דרך מערכת רישוי זמין. כולל תוכניות מיגון הכוללות מידות, חיזוקים ומיקום',
        priority: 'critical',
        planned_cost: 0,
        why_important: 'ממ"ד הוא חובה חוקית בכל בנייה חדשה. ללא אישור פיקוד העורף — הוועדה לא תוציא היתר',
        what_if_skip: 'לא ניתן לקבל היתר בנייה. עיכוב של שבועות עד חודשים',
        pro_tip: 'פיקוד העורף מחויב חוקית לתת תשובה תוך 14 יום מהגשה — מהגורמים המהירים ביותר. הגש מיד עם הגשת שאר הבקשות כדי לא לאבד זמן',
        is_required: true,
      },
      {
        name: 'תאגיד המים — תכנית סניטרית ותיאום חיבורים',
        description: 'הגשת תכנית סניטרית לתאגיד המים המקומי (כגון מי חדרה), תיאום חיבורי מים וביוב, תשלום דמי הקמה. נדרשת מפת מדידה מעודכנת של השנה האחרונה',
        priority: 'critical',
        planned_cost: 15000,
        why_important: 'ללא אישור תאגיד המים — לא ניתן לחבר מים וביוב. זה שלב מנדטורי לקבלת היתר',
        what_if_skip: 'אין חיבור מים/ביוב, עיכוב בהיתר, קנסות על חיבור לא מאושר',
        pro_tip: 'דמי ההקמה תלויים בקוטר השירה (צינור) ובמרחק מהרשת הקיימת — בקש הצעה מוקדמת. מפת מדידה חייבת להיות מהשנה האחרונה — אל תשתמש במפה ישנה',
        is_required: true,
      },
      {
        name: 'חברת חשמל — מיקום פילר וחיבור',
        description: 'תיאום עם חברת חשמל לגבי מיקום ארון החשמל (פילר), בדיקת קיבולת ועלות חיבור. יש להגיש בקשה דרך אתר חברת חשמל',
        priority: 'high',
        planned_cost: 8000,
        why_important: 'מיקום הפילר משפיע על תכנון החשמל של כל הבית. חיבור חשמל אינו מידי — לוקח חודשים להסדיר',
        what_if_skip: 'גילוי מאוחר שהמיקום לא מאושר, עלויות הנחת כבל לא מתוכננות, עיכוב בחיבור שירותים',
        pro_tip: 'פנה לחברת חשמל מוקדם ככל האפשר — הם לפעמים דורשים פרויקטים ותשלומים שלוקחים זמן. עדכן את האדריכל על מיקום הפילר שאושר',
        is_required: true,
      },
      {
        name: 'בזק — אישור וחיבור תשתיות תקשורת',
        description: 'קבלת אישור בזק/חברת תקשורת לחיבור תשתיות תקשורת (טלפון, אינטרנט, פיברופטיק). יש להגיש בקשה מוקדם לצרכי היתר',
        priority: 'normal',
        planned_cost: 2000,
        why_important: 'אישור בזק נדרש כחלק מהגשת ההיתר בחלק מהוועדות. תיאום מוקדם מונע עיכובים בחיבור בסיום הבנייה',
        what_if_skip: 'עיכוב בחיבור אינטרנט/טלפון בסיום הבנייה, לעתים דרישה לתעלות נוספות שיש לחפור מחדש',
        pro_tip: 'בדוק אם בישוב שלך יש תשתית סיב אופטי (פיברופטיק) — עדיף לבקש חיבור פיברופטיק כבר עכשיו. עולה לך עוד כמה אלפים אבל שווה לדורות',
        is_required: false,
      },
      {
        name: 'כבאות והצלה — אישור כבאות',
        description: 'קבלת אישור מכבאות והצלה לתוכניות הבית. בבתים פרטיים — בדרך כלל כולל בדיקת גישה לכבאים, מקום לארגזי אש ומיקום גז',
        priority: 'normal',
        planned_cost: 500,
        why_important: 'אישור כבאות נדרש להיתר בנייה. ביצוע לא תקין עלול לגרום לסירוב טופס 4 (אכלוס)',
        what_if_skip: 'עיכוב בקבלת טופס 4, דרישה לתיקונים יקרים בשלב הגמר',
        pro_tip: 'האדריכל בדרך כלל מטפל בזה — וודא שהכלול בהסכם שלך עמו. ברוב הבתים הפרטיים האישור פשוט יחסית',
        is_required: true,
      },
      {
        name: 'הגשה לוועדה המקומית + תשלום אגרות',
        description: 'הגשת כל המסמכים לוועדה המקומית לתכנון ובנייה דרך מערכת "רישוי זמין" (risuyzamin.gov.il). כולל אגרת בקשה, אגרת היתר ותשלום היטל השבחה',
        priority: 'critical',
        planned_cost: 8000,
        ...
        pro_tip: 'הגשה מתבצעת דרך "רישוי זמין" — ממשלתי ומרכז את כל הגורמים. בדוק ממוצע זמן טיפול בוועדה שלך — יש ועדות שלוקחות 6-18 חודש. קבל את כל אישורי הגורמים לפני כן',
        is_required: true,
      },
      {
